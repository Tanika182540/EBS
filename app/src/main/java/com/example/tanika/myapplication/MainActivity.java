...
import com.example.tanika.myapplication.socketObj.CommandSenderThread;
...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    CommandSenderThread commandSenderThread;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            printWriter = new PrintWriter(new BufferedWriter(
                    new OutputStreamWriter(Storage.getSocket().getOutputStream())),
                    true);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private String prev_command = "";
    private void sendCommand(String command){
        if(!prev_command.equals(command)) {
            new CommandSenderThread(printWriter).execute(command);
        }
